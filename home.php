...
<head><title>RUN FITNESS AND GYM</title>
...
<li class="home"><a>Home Page</a> </li>
    ...
    <li class="last"><img src="img/menu-right.gif" width="14" height="59" alt="RUN FITNESS AND GYM" /></li>
  </ul>
</div>
...
<div id="content">
 ...
 ?>
  ...
  <p> With Complete INformation RUN FITNESS AND GYM This is your Best Chance of getting in best shape of your life.</p>
...
<div class="copy"> 2021<sup>©</sup> Copyright RUN FITNESS AND GYM All Rights Reserved </div>
